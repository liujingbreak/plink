...
export class ResourceMap {
  ...
  get<T>(reference: ResourceKey<T> | WritableDraft<ResourceKey<T>>): T {
    return this.dataMap[reference as string];
  }

  delete<T>(reference: ResourceKey<T> | WritableDraft<ResourceKey<T>>): T {
    const o = this.dataMap[reference as string];
    if (this.dataMap.hasOwnProperty(reference as string) && o !== undefined)
      this.dataMap[reference as string] = undefined;
    return o;
  }
}
