...
import { EpicFactory, SliceHelper, createReducers } from './helper';
import { CreateSliceOptions } from '@reduxjs/toolkit';
export { EpicFactory, SliceHelper, ofPayloadAction, createReducers };
export declare function useReduxTookit<S, R extends SliceCaseReducers<S>>(optsFactory: () => CreateSliceOptions<S, R>, epicFactory: EpicFactory<S, R>): [state: S, slice: SliceHelper<S, R>];
