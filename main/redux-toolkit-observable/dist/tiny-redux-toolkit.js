...
function castByActionType(actionCreators, action$, byReducerNames) {
    var sourceSub;
    ...
    for (var _i = 0, _a = Object.keys(byReducerNames); _i < _a.length; _i++) {
