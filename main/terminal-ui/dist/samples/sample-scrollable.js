...
const label = (0, index_2.createTextWidget)('Hello border container', { debug: false, log });
const border = (0, index_3.createBorderContainer)(label, { debug: true, log });
...
const keyEventService = (0, index_5.createKeyEventService)({ debug: true, log });
