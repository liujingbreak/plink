...
import { createFlexContainer, createBorderContainer, createTextWidget } from '../index.js';
...
waitForImport$.subscribe(() => {
    ...
    const titleBorder = createBorderContainer(layout1TitleLabel, { name: 'title-border', debug: false, log });
    ...
    const scene = new SimplexReactor({
        name: 'scene',
        debug: true,
        log
    });
