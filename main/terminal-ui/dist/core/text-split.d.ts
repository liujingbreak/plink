...
export declare function createWordSplitter(opts?: CoreOptions<WordSplitterActions>): SimplexReactor<WordSplitterActions, readonly ["requestToken", "onWordRecorded"], object>;
/**
