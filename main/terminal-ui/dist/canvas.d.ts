...
type LineElement = IntervalTree<[units: number[], style: string]>;
...
declare const tableFor: readonly ["setBounding", "setRootComponent", "onDirtyLineChange", "internalCache"];
...
export declare function createTerminalCanvas(opts?: TerminalCanvasOptions): SimplexReactor<TerminalCanvasEvents, readonly ["setBounding", "setRootComponent", "onDirtyLineChange", "internalCache"]>;
