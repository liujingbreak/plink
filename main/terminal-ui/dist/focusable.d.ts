...
export declare function createRootService(keyEventService: KeyEventServcie, opts?: FocusableOptions): SimplexReactor<FocusableMessages & RootFocusableEvents, readonly ("onFocus" | "forRootComp" | "latestRenderedRect" | "_canvas" | "didFocus" | "handleKeyEvents" | "rootService" | "controlHandleEvents")[]>;
