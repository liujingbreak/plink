...
export declare function createTerminalCanvas(opts?: CoreOptions<TerminalCanvasInput & TerminalCanvasOutput>): SimplexReactor<TerminalCanvasInput & TerminalCanvasOutput, readonly ["setBounding", "setRootWidget", "onDirtyLineChange"], unknown>;
