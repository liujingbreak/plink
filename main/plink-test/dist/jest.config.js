...
const transform = {
    '\\.[mc]jsx?$': 'babel-jest',
    '\\.[mc]?tsx?$': [path_1.default.resolve(__dirname, 'ts-transformer.js'), {}]
};
...
const plinkPackageDir = path_1.default.resolve(init_plink_1.plinkRootDir, 'main/plink');
if (fs_1.default.existsSync(plinkPackageDir)) {
