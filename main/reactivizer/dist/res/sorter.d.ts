...
export declare function createSorter<D extends WritableArray>(comparator?: ForkSortComparator<D> | null, opts?: SimplexReactorCfgOpts<ForkWorkerInput & ForkWorkerOutput>): import("../fork-join/types").WorkerControl<import("..").ActionFactoryOfPlainType<{
