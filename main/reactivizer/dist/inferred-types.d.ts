...
export type SimplexReactorExtendType<RBase extends SimplexReactor<any, any>, I, L extends readonly (keyof I)[]> = SimplexReactor<InferActionsOfSmplxRctr<RBase> & I, readonly (InferTableForSmplxRctr<RBase> | L[number])[]>;
