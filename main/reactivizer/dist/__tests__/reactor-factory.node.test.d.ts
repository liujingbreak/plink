...
declare const baseFac: BaseReactorFactory<BaseActions, readonly ["res1", "msgX"], import("../stream-core.js").CoreOptions<BaseActions>, [greeting: string]>;
interface DerivedActions {
    msg2(greeting: string): SingleActionFactory;
    res2(hello: string): SingleActionFactory;
}
declare const derivedFac: import("../reactor-factory.js").DerivedReactorFactory<BaseActions & DerivedActions, ("res1" | "msgX" | "res2")[], [greeting: string], import("../stream-core.js").CoreOptions<BaseActions & DerivedActions>, []>;
interface DerivedActions2 {
    msg3(greeting: string): SingleActionFactory;
    res3(hello: string): SingleActionFactory;
}
declare const derivedFac2: import("../reactor-factory.js").DerivedReactorFactory<BaseActions & DerivedActions & DerivedActions2, ("res1" | "msgX" | "res2" | "res3")[], [], import("../stream-core.js").CoreOptions<BaseActions & DerivedActions & DerivedActions2>, []>;
