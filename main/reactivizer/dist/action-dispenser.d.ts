...
type InferInterface<X> = X extends SimplexReactor<infer Y, any> ? Y : X extends RxController2<infer I> ? I : X extends ForkedRxController<infer I> ? I : X extends ForkedPostRxController<infer I> ? I : X;
/**
