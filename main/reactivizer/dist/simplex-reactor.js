...
class SimplexReactor {
    constructor(opts) {
        ...
        this.opts = Object.assign({}, initial_options_1.initOptions);
        if (opts) {
        ...
        // }
        this.s = new control2_1.RxController2(Object.assign(Object.assign({}, this.opts), { name: ((_a = this.opts.name) !== null && _a !== void 0 ? _a : '') + `@${this.id}` }));
