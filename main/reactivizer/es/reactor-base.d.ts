...
export type SimplexReactorOptions<I = Record<never, never>, LI extends readonly (keyof I)[] = []> = LI['length'] extends 0 ? CoreOptions<I & BaseActions<I>> & {
    tableFor?: readonly [];
...
export type OptionsOfExtendSmplxRctr<Base extends SimplexReactor<any, any>, I, LI extends readonly (keyof I)[] = []> = SimplexReactorCfgOpts<InferActionsOfSmplxRctr<Base>, I, LI>;
/** Get type "CoreOption" from an inherited SimplexReactor */
export type CoreOptsOfExtSmplxRctr<Base extends SimplexReactor<any, any>, I = Record<never, never>> = CoreOptions<InferActionsOfSmplxRctr<Base> & I>;
