...
export type OptionsOfSmplxRctr<R extends SimplexReactor<any, any, any>> = NonNullable<R['opts']>;
...
export type OptionsOfExtendSmplxRctr<R extends SimplexReactor<any, any, any>, I, LI extends (readonly (keyof I)[] | (keyof I)[]) = []> = SimplexReactorCfgOpts<InferActionsOfSmplxRctr<R>, I, LI>;
