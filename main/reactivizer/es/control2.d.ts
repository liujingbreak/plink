...
export declare class RxController2<I> extends ControllerCore<I> {
    ...
    cancelAction(queryAction: Action): void;
    /**
     ...
     **/
    createDataTable<T extends keyof I, K>(actionType: T, keySelector: (action: InferMapParam<I[T]>) => K): ActionDataTable<I & ControllerBaseActions, T, K>;
    /**
