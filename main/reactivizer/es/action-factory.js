    ...
    od(response, ...moreResponses) {
        if (moreResponses.length === 0) {
            ...
            return onAllSubscribed(responses.map(r => {
                ...
                // rx.take(1),
                rx.switchMap(operator => r.pipe(operator(this.action), actionRelatedToAction(this.action))), timeoutLog((_a = this.opts.slowDispatchObservableTime) !== null && _a !== void 0 ? _a : 20000, this.opts.slowLog ? () => { this.opts.slowLog(this.action); } : () => {
