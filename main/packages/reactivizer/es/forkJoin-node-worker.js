    ...
    r('On output "fork" request message', o.at.fork.pipe(rx.mergeMap(act => {
        ...
        return rx.merge(rx.fromEventPattern(h => chan.port1.on('message', h), h => {
            ...
            if (parentPort) {
                ...
                if (broker == null) {
                    broker = createBroker(i, Object.assign(Object.assign({}, opts), { debug: (opts === null || opts === void 0 ? void 0 : opts.debug) ? 'ForkJoin-broker' : false, debugExcludeTypes: ['workerAssigned', 'assignWorker', 'workerInited', 'ensureInitWorker'], logStyle: 'noParam' }));
