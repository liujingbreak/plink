...
var apiCache = {};
(/** @type {any} */ (NodeApi.prototype)).apiForPackage = function(name) {
...
function setupNodeInjectorFor(pkInstance) {
	...
	.value('__injector', nodeInjector)
	.value('__api', api);
	(/** @type {any} */(nodeInjector)).default = nodeInjector; // For ES6 import syntax
}
