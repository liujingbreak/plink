...
const node_worker_1 = require("../../../packages//reactivizer/dist/fork-join/node-worker");
...
function createService() {
    ...
    r('dfsTraverseFiles -> doneDfsTraverseFiles', i.pt.dfsTraverseFiles.pipe(rx.tap(([m, files, tsconfig, alias, ignore]) => {
...
//# sourceMappingURL=cli-analyse-service.js.map