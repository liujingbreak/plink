        ...
        if (filePath != null) {
            program.command = function (nameAndArgs, ...restArgs) {
                ...
                subCmd.description = function (str, ...remainder) {
                    str = `[${chalk_1.default.cyan(pk.name)}] ` + str;
