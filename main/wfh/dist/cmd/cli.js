...
function subWfhCommand(program) {
    ...
    const cmdUpgrade = program.command('upgrade')
        ...
        .action(() => __awaiter(this, void 0, void 0, function* () {
        const scanNodeModules = require('../utils/symlinks').default;
        const deleted = yield scanNodeModules('all');
        if (cmdUpgrade.opts().plinkRepo) {
            (yield Promise.resolve().then(() => __importStar(require('./cli-link-plink')))).reinstallWithLinkedPlink(cmdUpgrade.opts().plinkRepo, deleted);
        }
