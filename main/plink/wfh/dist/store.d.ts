...
import { StateFactory, ofPayloadAction } from '@wfh/redux-toolkit-observable/dist/redux-toolkit-observable';
import { createReducers, action$Of, castByActionType } from '@wfh/redux-toolkit-observable/dist/helper';
...
export declare const dispatcher: import("@reduxjs/toolkit").CaseReducerActions<import("@wfh/redux-toolkit-observable/dist/helper").RegularReducers<StoreSetting, {
    ...
    processExit(): void;
    storeSaved(): void;
}> & import("@wfh/redux-toolkit-observable/dist/redux-toolkit-observable").ExtraSliceReducers<StoreSetting>, "storeSetting">;
