...
export declare function createPlinkPackageLookupService(): {
    ...
    table: import("@wfh/reactivizer").ActionTable<PlinkPackageLookupInput & PlinkPackageLookupOutput & PlinkPackageLookupInternal & import("@wfh/reactivizer").BaseActions<PlinkPackageLookupInput & PlinkPackageLookupOutput & PlinkPackageLookupInternal, readonly []>, readonly ("rootDir" | "__onError" | "__onDisposed" | "fromPackageService" | "pkgPathLenToPathMapChanged" | "packageToPathMap")[]>;
