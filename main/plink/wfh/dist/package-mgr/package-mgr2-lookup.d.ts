...
export declare function createPlinkPackageLookupService(): {
    ...
    table: import("@wfh/reactivizer").ActionTable<PlinkPackageLookupInput & PlinkPackageLookupOutput & PlinkPackageLookupInternal & import("@wfh/reactivizer").BaseActions<PlinkPackageLookupInput & PlinkPackageLookupOutput & PlinkPackageLookupInternal, readonly []>, readonly ("rootDir" | "fromPackageService" | "pkgPathLenToPathMapChanged" | "packageToPathMap" | "__onError" | "__onDisposed")[]>;
