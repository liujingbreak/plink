...
export declare function createService(log: (...args: string[]) => void): SimplexReactor<CmdChildProcessInput & CmdChildProcessEvents, readonly ["setRootDir", "onCommanderInited"], unknown>;
export {};
