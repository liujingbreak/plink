...
export declare const cmdModelService: ReactorComposite2<CmdActions, CmdEvents, readonly ["enableRxMessageTrace", "setRootDir", "setActiveInstallSpace"], readonly ["load"]>;
export {};
