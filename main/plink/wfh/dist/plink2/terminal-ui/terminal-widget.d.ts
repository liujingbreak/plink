...
declare const tableForBase: readonly ["setSize", "overflow", "preferredSize", "prefHeightFor", "prefWidthFor", "setParent", "needRerender", "clearBackground"];
...
export declare function createBase(): SimplexReactor<BaseWidgetActions, readonly ["setSize", "overflow", "preferredSize", "prefHeightFor", "prefWidthFor", "setParent", "needRerender", "clearBackground"]>;
...
declare const tableFor: readonly ["allChildren", "setLayoutValid"];
...
export declare function createContainerBase(): SimplexReactor<BaseWidgetActions & ContainerWidgetInput & ContainerWidgetOutput, ("setSize" | "overflow" | "preferredSize" | "prefHeightFor" | "prefWidthFor" | "setParent" | "needRerender" | "clearBackground" | "allChildren" | "setLayoutValid")[]>;
export {};
