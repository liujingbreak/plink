...
const border = (0, terminal_featured_widget_1.createBorderContainer)(label.asBaseType);
border.config({ debug: true, log });
border.s.ft.init().dp();
const scrollable = (0, terminal_scrollable_1.createScrollable)(border.asBaseType.asBaseType);
