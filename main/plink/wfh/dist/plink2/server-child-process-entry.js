...
if (process.send) {
    r('events should be lifted to parent process', rx.merge(o.at.onCommandError, o.at.onCommandDone, o.at.onReady, o.at.onShutdown, o.at.__onError).pipe(rx.map(a => process.send({
        type: 'rx:message',
