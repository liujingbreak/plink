...
export declare const dispatcher: import("@reduxjs/toolkit").CaseReducerActions<import("@wfh/redux-toolkit-observable/dist/helper").RegularReducers<AnalyzeState, {
