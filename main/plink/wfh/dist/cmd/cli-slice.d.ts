...
export declare const cliSlice: import("@reduxjs/toolkit").Slice<CliState, import("@wfh/redux-toolkit-observable/dist/helper").RegularReducers<CliState, {
...
}> & import("@wfh/redux-toolkit-observable").ExtraSliceReducers<CliState>, "cli">;
export declare const cliActionDispatcher: import("@reduxjs/toolkit").CaseReducerActions<import("@wfh/redux-toolkit-observable/dist/helper").RegularReducers<CliState, {
    plinkUpgraded(d: CliState, newVersion: string): void;
    updateLocale(d: CliState, [lang, country]: [string, string]): void;
    addCommandMeta(d: CliState, { pkg, metas }: {
        pkg: string;
