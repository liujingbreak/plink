...
export default function walkPackagesAndSetupInjector(config: DrcpConfig, browserOptions: AngularBuilderOptions, ssr?: boolean): Promise<ReturnType<typeof walkPackages>>;
