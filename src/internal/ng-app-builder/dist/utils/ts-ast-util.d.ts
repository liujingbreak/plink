...
export declare function resolveImportBindName(src: ts.SourceFile, modulePath: string, propertyName: string, resolveFn?: (targetPath: string, currFile: string) => string): string;
/**
